"""Fast dependency, ROM, and protocol checks before Rainbow compute."""
...
EXPECTED_VERSIONS = {"ale-py": "0.11.2", "gymnasium": "1.2.3", "opencv-python-headless": "4.13.0.92"}
...
def preflight_rainbow_2018(papers_dir: Path = Path("papers")) -> dict[str, Any]:
    """Open and step every frozen game, returning reviewable machine facts."""
    ...
    spec = load_reproduction_spec(papers_dir / "rainbow-2018" / "reproduction.yaml")
